...
func StackBlur(src image.Image, radius uint32) (*image.NRGBA, error) {
	var (
		stackEnd *blurStack
		stackIn  *blurStack
		stackOut *blurStack
...
// toNRGBAForStackBlur converts an image type to *image.NRGBA with min-point at (0, 0).
func toNRGBAForStackBlur(img image.Image) *image.NRGBA {
